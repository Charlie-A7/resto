    ...
    <section class="dashboard">
        <div class="dashboard-content p-4 p-lg-5 px-lg-4">
            ...
            <div class="dashboard-cards d-flex justify-content-center text-center flex-wrap">
                <div class="card m-2 p-3" onclick="navigateTo('reservations')">
                    <div class="card-icon">
                ...
                <div class=" card m-2 p-3" onclick="navigateTo('menu')">
                    <div class="card-icon">
                ...
                <div class="card m-2 p-3" onclick="navigateTo('analytics')">
                    <div class="card-icon">
                ...
                <div class="card m-2 p-3" onclick="navigateTo('contact')">
                    <div class="card-icon">
